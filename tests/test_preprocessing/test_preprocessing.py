...
def raw_data():
    ...
    data = pd.read_json("tests/test_preprocessing/sample_data_v2.json", dtype={"Image_Name": "string"})
    return data
...
def expanded_data():
    ...
    data = pd.read_json("tests/test_preprocessing/sample_data_v2_expanded.json", dtype={"Image_Name": "string"})
    return data
...
def noisy_expanded_data():
    ...
    data = pd.read_json("tests/test_preprocessing/sample_data_v2_expanded_noisy.json", dtype={"Image_Name": "string"})
    return data
