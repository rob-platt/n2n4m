...
def run_training(model_name: str, kernel_size: int, depth: int, num_blocks: int, num_bland_pixels: int):
    """
    ...
    # Instantiate a model
    model = Noise2Noise1D(kernel_size=kernel_size, depth=depth, num_blocks=num_blocks, num_input_features=len(PLEBANI_WAVELENGTHS))
